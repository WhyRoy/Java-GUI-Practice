...
import GUI.Panel.UserInfoPanelPackage.*;
...
public class UserInfoPanel extends JPanel {
    ...
    private JPanel getUpPanel() {
        ...
        JLabel labeltitle = new JLabel("用户信息操作");
    ...
    private JPanel getCenterPanel() {
        ...
        labelshowbyid = new JLabel("查询用户");
        labeladdone = new JLabel("添加用户");
        labeldeleteone = new JLabel("删除用户");
        labelupdateone = new JLabel("更新用户");
        //设置字体
    ...
    private void addListener() {
        panelshowall.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                UserInfoPanel.settingPanelMain.add(settingpanelshowall, BorderLayout.CENTER);
        ...
        panelshowbyid.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                UserInfoPanel.settingPanelMain.removeAll();
                UserInfoPanel.settingPanelMain.add(settingpanelshowbyid, BorderLayout.CENTER);
        ...
        paneladdone.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                UserInfoPanel.settingPanelMain.removeAll();
                UserInfoPanel.settingPanelMain.add(settingpaneladdone, BorderLayout.CENTER);
        ...
        paneldeleteone.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                UserInfoPanel.settingPanelMain.removeAll();
                UserInfoPanel.settingPanelMain.add(settingpaneldeleteone, BorderLayout.CENTER);
        ...
        panelupdateone.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                UserInfoPanel.settingPanelMain.removeAll();
                UserInfoPanel.settingPanelMain.add(settingpanelupdateone, BorderLayout.CENTER);
